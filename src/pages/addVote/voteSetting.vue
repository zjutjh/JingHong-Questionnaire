    ...
    <div class="w-900 bg-gray-100 dark:bg-gray-700 border rounded-sm p-6 mb-5 shadow-md">
      ...
      <div class="w-full px-4">
        <div class="flex items-center mt-6 mb-2.5 space-x-8">
          <span class="ml-30 mt-20 mb-20 mr-15 w-100">最少选择</span>
          <div class="flex items-center space-x-4">
            <el-input-number v-model="schema.quesConfig.questionList[0].quesSetting.minimumOption" :min="1" :max="schema.quesConfig.questionList[0].options.length" />
          </div>
        </div>
      </div>
      <div class="w-full px-4">
        <div class="flex items-center mt-6 mb-2.5 space-x-8">
          <span class="ml-30 mt-20 mb-20 mr-15 w-100">最多选择</span>
          <div class="flex items-center space-x-4">
            <el-input-number v-model="schema.quesConfig.questionList[0].quesSetting.maximumOption" :min="schema.quesConfig.questionList[0].quesSetting.minimumOption" :max="schema.quesConfig.questionList[0].options.length" />
          </div>
        </div>
      </div>
      <div class="w-full px-4">
