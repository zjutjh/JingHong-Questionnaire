<template>
  <div class="bg-base-100 flex-1">
    ...
    <div v-if="activeSerial !== -1" class="pl-16">
      <!-- 所有题型通用 -->
      <div class="text-sm font-medium">基础配置</div>
      <div class="pt-8">
        <el-checkbox
      ...
      <!-- 有其他选项 -->
      <div
        v-if="currentType === QuesItemType.CHECKBOX || currentType === QuesItemType.RADIO"
        class="pt-2"
      >
        <el-checkbox
      ...
      <div class="pt-16 text-sm font-medium">引导介绍文案</div>
      ...
      <!-- 填空特殊逻辑 -->
      <div
        v-if="currentType === QuesItemType.INPUT || currentType === QuesItemType.TEXTAREA"
        class="pt-24"
      >
        <div class="text-sm font-medium">内容格式限制</div>
        <div class="pt-16">
      ...
      <div v-if="currentType === QuesItemType.CHECKBOX" class="pt-24">
        <div class="text-sm font-medium">选项配置</div>
        <div class="pt-16">
          <div>
      ...
      <!-- 选择操作 -->
      <div
        v-if="currentType === QuesItemType.RADIO || currentType === QuesItemType.CHECKBOX"
        class="pt-24"
      >
        <el-button @click="addOption(activeSerial)"> 增加选项 </el-button>
      </div>
    </div>
  </div>
</template>
